...
var ClassParser = /** @class */ (function () {
    ...
    ClassParser.parse = function (json) {
        ...
        if (json) {
            ...
            obj.className = obj.id = json.className ? json.className : '';
        }
        else {
...
module.exports = "<div>\n  <div fxLayout=\"row\">\n    <mat-toolbar class=\"secondary-item\">\n      <mat-toolbar-row fxLayout=\"row\" >\n        <div fxFlex=\"30\" fxLayoutAlign=\"start center\">\n          {{projectTitle}}\n        </div>\n        <div fxFlex=\"70\" fxLayoutAlign=\"end center\">\n          <button mat-button (click)=\"goToPage('opportunity')\"><img src=\"assets/images/icons/ic_opportunity.png\" class=\"button-icon\">Oportunidade</button>\n          <button mat-button (click)=\"goToPage('interaction')\"><img src=\"assets/images/icons/ic_interaction.png\" class=\"button-icon\">Interação</button>\n          <button mat-button><img src=\"assets/images/icons/ic_concetration.png\" class=\"button-icon\">Concentração</button>\n          <button mat-button><img src=\"assets/images/icons/ic_creation.png\" class=\"button-icon\">Criação</button>\n          <button mat-button><img src=\"assets/images/icons/ic_evaluation.png\" class=\"button-icon\">Avaliação</button>\n          <button mat-button><img src=\"assets/images/icons/ic_projection.png\" class=\"button-icon\">Projetação</button>\n        </div>\n      </mat-toolbar-row>\n    </mat-toolbar>\n  </div>  \n\n  <div fxLayout=\"row\" class=\"container\">\n      <div fxLayout=\"column\" fxFlex=\"15\"></div>\n      <div fxLayout=\"column\" fxFlex=\"70\">\n        <div fxLayout=\"row\"  fxLayoutAlign=\"start center\">\n          <router-outlet></router-outlet>\n        </div>\n      </div>\n      <div fxLayout=\"column\" fxFlex=\"15\"></div>\n  </div>  \n</div>"
...
var ProjectComponent = /** @class */ (function () {
    ...
    ProjectComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.projectService.getProjects().subscribe(function (result) {
            ...
            console.log('Erro nessa caralha' + error);
        });
    };
...
var ProjectService = /** @class */ (function () {
    ...
    ProjectService.prototype.getProjects = function () {
        return this.domApi
            .get(__WEBPACK_IMPORTED_MODULE_2__app_util_read_only_util__["a" /* ReadOnlyUtil */].RequestPaths.SERVER_ROOT + "/" + __WEBPACK_IMPORTED_MODULE_2__app_util_read_only_util__["a" /* ReadOnlyUtil */].RequestPaths.PROJECT);
    };
...
var DomApiService = /** @class */ (function () {
    ...
    DomApiService.prototype.post = function (url, body) {
        return this.http
            .post(url, body, this.interceptor())
    ...
    DomApiService.prototype.postMultiPart = function (url, formData) {
        return this.http
            .post(url, formData, this.interceptor())
            .map(function (res) { return res.json(); })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["a" /* Observable */].throw(error.json() || 'Server error'); });
    };
    DomApiService.prototype.put = function (url, body) {
        return this.http
            .put(url, body, this.interceptor())
            .map(function (res) { return res.json(); })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["a" /* Observable */].throw(error.json() || 'Server error'); });
    };
    DomApiService.prototype.patch = function (url, body) {
        return this.http
            .patch(url, body, this.interceptor())
            .map(function (res) { return res.json(); })
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["a" /* Observable */].throw(error.json() || 'Server error'); });
    };
...
var ReadOnlyUtil = /** @class */ (function () {
    ...
    ReadOnlyUtil.RequestPaths = {
        SERVER_ROOT: __WEBPACK_IMPORTED_MODULE_0__environments_environment_prod__["a" /* environment */].server,
        PROJECT: 'projects',
        STUDENT: 'students',
        CLASS: 'classes',
        MONITOR: 'monitors',
...
var environment = {
    production: true,
    server: 'http://localhost:9200/dom'
};
